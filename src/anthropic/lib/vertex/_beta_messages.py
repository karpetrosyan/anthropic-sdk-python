...
class Messages(SyncAPIResource):
    ...
    count_tokens = reject_output_format_and_config(FirstPartyMessagesAPI.count_tokens)
...
class AsyncMessages(AsyncAPIResource):
    ...
    stream = reject_output_format_and_config(FirstPartyAsyncMessagesAPI.stream)
    tool_runner = reject_output_format_and_config(FirstPartyAsyncMessagesAPI.tool_runner)
    count_tokens = reject_output_format_and_config(FirstPartyAsyncMessagesAPI.count_tokens)
