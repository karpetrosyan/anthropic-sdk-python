...
class Messages(SyncAPIResource):
    ...
    def create(
        ...
        **kwargs: Unpack[message_create_params.MessageCreateParamsNonStreaming],
    ) -> Message: ...
    @overload
    def create(
        self,
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
        **kwargs: Unpack[message_create_params.MessageCreateParamsStreaming],
    ...
    def create(  # type: ignore
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
        **kwargs: Unpack[message_create_params.MessageCreateParamsNonStreaming],  # type: ignore
        ...
        if not kwargs.get("stream", False) and not is_given(timeout) and self._client.timeout == DEFAULT_TIMEOUT:
            timeout = self._client._calculate_nonstreaming_timeout(
                kwargs["max_tokens"], MODEL_NONSTREAMING_TOKENS.get(model, None)
            )
